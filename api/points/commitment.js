import { commitDailyCommitmentReward, getAuthUserByIdToken, getDocument } from '../lib/firebaseRest.js';
...
export default async function handler(request, response) {
  ...
  try {
    ...
    console.error('Commitment reward API error:', error);
    return response.status(500).json({ error: 'Nao foi possivel registrar o selo de compromisso.' });
  }
}
